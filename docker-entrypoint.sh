...
MIGRATION_NEEDED=$(mysql -h mysql -P 3306 -u root -proot -D nest_admin -e "SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = 'nest_admin' AND table_name = 'migrations';" -s -N 2>/dev/null || echo "1")
